...
require (
	...
	github.com/dgmann/document-manager/api v0.0.0-20180814214107-86ddee701676 // indirect
	github.com/dgmann/document-manager/api-client v0.0.0-20180814214107-86ddee701676
	github.com/dgmann/document-manager/shared v0.0.0-20180814214107-86ddee701676 // indirect
